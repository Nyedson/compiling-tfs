...
void Game::playerNpcGreet(uint32_t playerId, uint32_t npcId)
{
	...
	if(npc) {
        ...
        SpectatorHashSet realSpectators;
        map.getSpectators(realSpectators, player->getPosition(), true, true);
        internalCreatureSay(player, TALKTYPE_SAY, "Hi", false, &realSpectators);
