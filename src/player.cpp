...
bool Player::updateSaleShopList(const Item* item)
{
	...
	uint16_t itemId = item->getID();
	if ((currency == ITEM_GOLD_COIN && itemId != ITEM_GOLD_COIN && itemId != ITEM_PLATINUM_COIN && itemId != ITEM_CRYSTAL_COIN && itemId != ITEM_GOLD_BAR) || (currency != ITEM_GOLD_COIN && itemId != currency)) {
