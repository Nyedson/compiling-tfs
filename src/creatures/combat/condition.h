...
class ConditionCreatureIcon final : public Condition
{
public:
  ConditionCreatureIcon(ConditionId_t initId, ConditionType_t initType, int32_t iniTicks, bool initBuff = false, uint32_t initSubId = 0) :
  ...
  ConditionCreatureIcon* clone() const override {
    return new ConditionCreatureIcon(*this);
  }
