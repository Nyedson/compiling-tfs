...
class Monster final : public Creature
{
	public:
		...
		bool hasFoughtSinceSpawn() const {
			return hasFought;
		}

		int32_t getInfluencedLevel() const {
			return influencedLevel;
		}

		void setInfluencedLevel(int32_t value);
		bool isFromRaid() const {
			return raidMonster;
		}
		void setFromRaid(bool value) {
			raidMonster = value;
		}
	...
	private:
		...
		bool raidMonster = false;
		int32_t influencedLevel = 0;
