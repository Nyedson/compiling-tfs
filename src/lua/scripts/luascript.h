...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaGameGetBosstiaryList(lua_State* L);
		...
		static int luaGameGetRandomMonster(lua_State* L);
		...
		static int luaPlayerGetBossSlot(lua_State* L);
		static int luaPlayerGetLevelByBossPoints(lua_State* L);
		static int luaPlayerGetBossPoints(lua_State* L);
		...
		static int luaPlayerGetBestiaryKills(lua_State* L);
		...
		static int luaPlayerGetDust(lua_State* L);
		static int luaPlayerSetDust(lua_State* L);

		static int luaPlayerGetMaximumDust(lua_State* L);
		static int luaPlayerSetMaximumDust(lua_State* L);
		...
		static int luaMonsterIsFromRaid(lua_State* L);

		static int luaMonsterIsIdle(lua_State* L);
		static int luaMonsterSetIdle(lua_State* L);

		static int luaMonsterHasFoughtSinceSpawn(lua_State* L);

		static int luaMonsterGetInfluencedLevel(lua_State* L);
		static int luaMonsterSetInfluencedLevel(lua_State* L);
		...
		// Bosstiary
		static int luaMonsterTypeBossid(lua_State* L);
		static int luaMonsterTypeBosstiaryCategory(lua_State* L);
