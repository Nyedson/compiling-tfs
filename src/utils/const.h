...
enum MagicEffectClasses : uint8_t {
	...
	CONST_ME_ONSLAUGHT = 230,
	CONST_ME_RUSE = 231,
	CONST_ME_MOMENTUM = 232,

	CONST_ME_LAST = CONST_ME_MOMENTUM,
};
...
enum MonsterCreatureIcon_t {
	CREATUREICON_NONE = 0,
	CREATUREICON_HIGHERRECEIVEDDAMAGE = 1,
	CREATUREICON_LOWERDEALTDAMAGE = 2,
	CREATUREICON_TURNEDMELEE = 3,
	CREATUREICON_INFLUENCED = 4,
	CREATUREICON_FIEND = 5,
};

enum PlayerCreatureIcon_t {
	CREATUREICON_GRAYSWORD = 1,
	CREATUREICON_REDSWORD = 2,
	CREATUREICON_REDBALL = 3,
	CREATUREICON_GREENBALL = 4,
	CREATUREICON_REDGREENBALL = 5,
...
static constexpr int32_t STORAGEVALUE_BOSSTIARYKILLCOUNT = 62305000; 
