...
static int32_t getOnSlaughtValue(uint16_t tier) {
	return static_cast<int32_t>((tier*tier + 8*tier + 1)/20.*100);
}

static int32_t getRuseValue(uint16_t tier) {
	std::vector<int32_t> values = {0, 50, 103, 162, 228, 300, 378, 462, 552, 648, 751};
	int32_t result = values[tier];
	if (result)
		return result;
	else
		return 0;
...
static int32_t getMomentumValue(uint16_t tier) {
	return static_cast<int32_t>((tier*tier + 38*tier + 1)/20.*100);
}
