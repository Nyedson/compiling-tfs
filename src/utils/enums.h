...
enum MarketRequest_t {
	MARKETREQUEST_OWN_HISTORY = 0x01,
	MARKETREQUEST_OWN_OFFERS = 0x02,
	MARKETREQUEST_BROWSE_ITEM = 0x03,
	MARKETREQUEST_ACCEPT_OFFER = 0x04,
	MARKETREQUEST_CANCEL_OFFER = 0x05,
};

enum MarketRequest_Old_t {
	MARKETREQUEST_OLD_OWN_OFFERS = 0xFFFE,
	MARKETREQUEST_OLD_OWN_HISTORY = 0xFFFF,
};
...
enum BosstiaryCategory_t : uint8_t {
	BOSSTIARY_CATEGORY_NONE = 0,
	BOSSTIARY_CATEGORY_BANE = 0,
	BOSSTIARY_CATEGORY_ARCHFOE = 1,
	BOSSTIARY_CATEGORY_NEMESIS = 2,
};

enum BosstiaryProgress_t : uint8_t {
	BOSSTIARY_PROGRESS_NONE = 0,
	BOSSTIARY_PROGRESS_PROWESS = 1,
	BOSSTIARY_PROGRESS_EXPERTISE = 2,
	BOSSTIARY_PROGRESS_MASTERY = 3,
};

enum BosstiaryConfiguration_t : uint16_t {
	BOSSTIARY_CONF_BASE_EQUIPMENT_BONUS = 25,
	BOSSTIARY_CONF_MIN_BOSS_POINTS_SECOND_SLOT = 1500,
	BOSSTIARY_CONF_EXTRA_EQUIPMENT_BONUS_MASTERY = 25,
	BOSSTIARY_CONF_BOOSTED_BOSS_EQUIPMENT_BONUS = 250,
	BOSSTIARY_CONF_BOOSTED_BOSS_KILL_COUNT = 3,
};

enum BosstiaryKills_t : uint16_t {
	BOSSTIARY_KILLS_BANE_PROWESS = 25,
	BOSSTIARY_KILLS_BANE_EXPERTISE = 100,
	BOSSTIARY_KILLS_BANE_MASTERY = 300,
	BOSSTIARY_KILLS_ARCHFOE_PROWESS = 5,
	BOSSTIARY_KILLS_ARCHFOE_EXPERTISE = 20,
	BOSSTIARY_KILLS_ARCHFOE_MASTERY = 60,
	BOSSTIARY_KILLS_NEMESIS_PROWESS = 1,
	BOSSTIARY_KILLS_NEMESIS_EXPERTISE = 3,
	BOSSTIARY_KILLS_NEMESIS_MASTERY = 5,
};

enum BosstiaryPoints_t : uint16_t {
	BOSSTIARY_POINTS_BANE_PROWESS = 5,
	BOSSTIARY_POINTS_BANE_EXPERTISE = 15,
	BOSSTIARY_POINTS_BANE_MASTERY = 30,
	BOSSTIARY_POINTS_ARCHFOE_PROWESS = 10,
	BOSSTIARY_POINTS_ARCHFOE_EXPERTISE = 30,
	BOSSTIARY_POINTS_ARCHFOE_MASTERY = 60,
	BOSSTIARY_POINTS_NEMESIS_PROWESS = 10,
	BOSSTIARY_POINTS_NEMESIS_EXPERTISE = 30,
	BOSSTIARY_POINTS_NEMESIS_MASTERY = 60,
};
...
enum ConditionParam_t {
  ...
  CONDITION_PARAM_CREATUREICON_ID = 58,
	CONDITION_PARAM_CREATUREICON_PLAYERICON = 59,
	CONDITION_PARAM_CREATUREICON_VALUE = 60,
};
